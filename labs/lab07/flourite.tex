...
\framebox[15cm][l]{\textbf{General Mineral Formula}: \ce{CaF2} }\
\framebox[15cm][l]{\textbf{Mineral Chemical Class}:  }\
\framebox[15cm][l]{\textbf{Specific Gravity}:  }\
\framebox[15cm][l]{\textbf{Hardness}:  }\
\framebox[15cm][l]{\textbf{Cleavage}: \hl{1, all Sides} }\
\framebox[15cm][l]{\textbf{Luster}: \hl{Vitreous, glassy} }\
\framebox[15cm][l]{\textbf{Streak}:  }\
\framebox[15cm][l]{\textbf{Characteristic Color(s)}:  }\
\framebox[15cm][l]{\textbf{Crystal System}: \hl{Isometric} }\
