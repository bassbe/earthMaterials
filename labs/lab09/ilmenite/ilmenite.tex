...
\date{6 April 2016}
\title{\vspace{-2.0cm}Ilmenite} %bring title up temporary Fix
...
\begin{center}
  \includegraphics[scale=.25]{ilmenite1}\footnote{This piece of Ilmenite is its trademark black color, it has a metallic luster, and it's not magnetic.}
  \includegraphics[scale=.45]{ilmenite2}\footnote{In addition to not being magnetic, the metallic luster and black color of this sample help identify it.}
\end{center}



\framebox[15cm][l]{\textbf{General Mineral Formula}: \ce{FeTiO3} }\
...
\framebox[15cm][l]{\textbf{Characteristic Color(s)}: \hl{Black} }\
\framebox[15cm][l]{\textbf{Crystal System}:  }\
\framebox[15cm][l]{\textbf{Crystal Class}:  }\
\framebox[15cm][l]{\textbf{Special}:\hl{Not Metallic}  }\
