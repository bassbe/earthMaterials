...
\begin{center}
  \includegraphics[scale=.05]{muscovite}
\footnote{pure muscovite}
  \includegraphics[scale=.05]{muscovite_inarock}\footnote{muscovite in a rock}
\end{center}
...
\framebox[15cm][l]{\textbf{Characteristic Color(s)}: Colorless, white, beige, yellow }\
