...
\date{2 March 2016}
\title{\vspace{-2.0cm}Ensatite} %bring title up temporary Fix
...
\framebox[15cm][l]{\textbf{General Mineral Formula}: $(Mg,Fe)_{2}Si_{2}O_{6}$ }\
\framebox[15cm][l]{\textbf{Mineral Chemical Class}: Inosilicate : single chain pyroxene : clinopyroxene}\
