...
\begin{center}
  \includegraphics[scale=.05]{glaucophane}\footnote{Distinctive blue color in hand sample. Usually prismatic with diamond shaped cross section. Playt insmall groups of crystals. Fibrous, massive, striated lengthwise.}
\end{center}
...
\framebox[15cm][l]{\textbf{Cleavage}: \hl{1,2 Conchoidal to uneven fracture. Brittl. Fibers are flexible.} }\
\framebox[15cm][l]{\textbf{Luster}: Vitreous, pearly }\
\framebox[15cm][l]{\textbf{Streak}: Grayish, blue }\
\framebox[15cm][l]{\textbf{Characteristic Color(s)}: \hl{Blue, dark blue. Black with blue overtones} }\
