...
\date{23 March 2016}
\title{\vspace{-2.0cm}Aragonite} %bring title up temporary Fix
...
\begin{center}
  \includegraphics{aragonite}
  \includegraphics[scale=.2]{aragonite2}
\end{center}
...
\framebox[15cm][l]{\textbf{HCL}:\hl{Reacts with HCl}  }\

\begin{framed}
  \textbf{Crystal Description (common forms, habit, etc.)}: \hl{ Crystal shape is hexagonal and long with striations}
\end{framed}
