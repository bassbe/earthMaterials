...
\date{30 March 2016}
\title{\vspace{-2.0cm}Malachite} %bring title up temporary Fix
...
\begin{center}
  \includegraphics[scale=.4]{malachite}\footnote{Obnoxiously green color. Very particular to Malachite.}
  \includegraphics[scale=.2]{malachite2}\footnote{Again, very remarkable green color. Make sure you scratch it up. It'll leave a tourquoise green color. Streak is important for identifying this one.}
\end{center}



\framebox[15cm][l]{\textbf{General Mineral Formula}: \ce{Cu2CO3(OH)2 } }\
...
\framebox[15cm][l]{\textbf{Streak}: \hl{Tourquoise Green} }\
\framebox[15cm][l]{\textbf{Characteristic Color(s)}: \hl{Vivid Green!} }\
