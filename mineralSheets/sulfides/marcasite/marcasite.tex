...
\date{30 March 2016}
\title{\vspace{-2.0cm}Marcasite} %bring title up temporary Fix
...
\begin{center}
  \includegraphics[scale=.4]{marcasite1}\footnote{Look at the cruddy, crumbly mineral. Metallic luster easy to see when cut fresh. Can kind of see the cockscomb formation. Easy to powder.}
  \includegraphics[scale=.4]{marcasite2}\footnote{Again, cruddy, metallicy(sort of), with cockscomb. Powders easily.}
\end{center}
