...
\date{23 March 2016}
\title{\vspace{-2.0cm}Barite} %bring title up temporary Fix
...
\begin{center}
  \includegraphics[scale=.5]{barite}\footnote{Platy Crystal shape. Also heavy but this specimine looks heavy already..}
  \includegraphics[scale=.5]{barite2}\footnote{Platy crystal shape. If you could pick it up, it would be heavy for it's size.}
\end{center}



\framebox[15cm][l]{\textbf{General Mineral Formula}: \ce{BaSO4} }\
\framebox[15cm][l]{\textbf{Mineral Chemical Class}:  }\
\framebox[15cm][l]{\textbf{Specific Gravity}: \hl{4.5 DENSE} }\
...
\framebox[15cm][l]{\textbf{Confused with}: Calcite, Flourite, feldspar }\
